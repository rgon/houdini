import { rootID } from '../cache/stuff.js'
import { marshalInputs } from '../lib/index.js'
import { keyFieldsForType } from '../lib/config.js'
import type { FragmentArtifact, GraphQLObject } from '../lib/types.js'
